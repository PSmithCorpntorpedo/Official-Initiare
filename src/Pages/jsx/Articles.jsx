...
function Paginate() {
  ...
  useEffect(() => {
    const getArticles = async () => {
      const res = await fetch(
        `https://initiare-clone-a22c10683333.herokuapp.com/api/v1/articles?Page=1&Size=12`
      );
  ...
  const fetchPageArticles = async (page) => {
    const res = await fetch(
      `https://initiare-clone-a22c10683333.herokuapp.com/api/v1/articles?Page=${page}&Size=12`
    );
    const data = await res.json();
    return data;
  };
